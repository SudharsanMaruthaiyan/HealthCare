...
const Trichy1 = ({
  ...
  return (
    <>
      <div
        className=" w-fit h-fit p-5 space-x-2 space-y-3 shadow-2xl shadow-orange-50 m-3 bg-white rounded-2xl 
      ...
      >
        ...
        <Link to={google_maps}>
          <p className="py-1 px-3 shadow-2xl bg-gradient-to-r from-[#2dd4bf]  to-[#1f2937] p-2 text-center rounded-xl">
            Maps!
          </p>
        </Link>
      </div>
...
const Trichys = () => {
  return (
    <>
      <h1 className="font-[Roboto] text-2xl mt-8 ml-10">
